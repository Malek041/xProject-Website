...
const StrictFilter = () => {
    ...
    return (
        <section style={{ padding: '10rem 0', backgroundColor: '#ffffff', color: 'var(--color-dark)' }}>
                            ...
                            <div style={{ borderBottom: '1px solid #f5f5f7', paddingBottom: '2rem' }}>
                                ...
                                >
                                    ...
                                    <h3 style={{ fontSize: '1.5rem', fontWeight: '500', color: '#1d1d1f' }}>
                                        {t({ en: "Who needs xProject", fr: "Qui a besoin de xProject" })}
                                    </h3>
                                </div>
                                <AnimatePresence>
                                    {openSections.good && (
                            ...
                            <div style={{ paddingBottom: '2rem' }}>
                                ...
                                >
                                    ...
                                    <h3 style={{ fontSize: '1.5rem', fontWeight: '500', color: '#86868b' }}>
                                        {t({ en: "Who Don't Need xProject", fr: "Qui n'a pas besoin de xProject" })}
                                    </h3>
                                </div>
                                <AnimatePresence>
                                    {openSections.bad && (
